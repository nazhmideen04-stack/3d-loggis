...
<body>
    ...
    <script>
        ...
        // 2. ПАЛИТРА ДЛЯ BOYUNA GERİNİM (S) - Осевая деформация (Сжатие/Растяжение)
        const axialStops = [
        ...
        // Выбор палитры строго по текущему типу
        ...
        // ТОЧНЫЙ ГРАДИЕНТ ЛЕГЕНДЫ ИЗ МАССИВА ЦВЕТОВ THREE.JS СЦЕНЫ
