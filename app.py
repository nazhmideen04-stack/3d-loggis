...
# Точный метод получения живых данных по вашему эталонному шаблону
...
def fetch_all_categories_data():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            st.warning(f"LoggIS verisi alınırken gecikме oluştu: {e}")
        finally:
            browser.close()
...
<body>
    ...
    <script>
        ...
        // Сохранение позиции камеры при вращении
        controls.addEventListener('change', () => {
            ...
            try {
                window.sessionStorage.setItem('threejs_camera_state', JSON.stringify(camState));
            } catch(e) {}
        });
