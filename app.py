...
<body>
    ...
    <script>
        ...
        // 2. Boyuna gerinim (S): МНОГОСЛОЙНЫЙ ГРАДИЕНТ БЕЗ СЛИЯНИЯ В 2 ЦВЕТА И БЕЗ БЕЛОГО
        // Фиолетовый -> Синий индиго -> Глубокая маджента -> Малиновый -> Коралловый оранж -> Сочный неоново-розовый
        const axialStops = [
            new THREE.Color("#1A0033"), // 0%: Темный фиолетовый (минимум)
            new THREE.Color("#300554"), // 15%: Глубокий сливовый
            new THREE.Color("#560B68"), // 30%: Пурпурно-фиолетовый
            new THREE.Color("#881477"), // 45%: Насыщенная маджента
            new THREE.Color("#BF2077"), // 60%: Сочный малиновый
            new THREE.Color("#E8395B"), // 75%: Яркий кораллово-красный (создает контрастную границу)
            new THREE.Color("#FA557D"), // 90%: Теплый розовый
            new THREE.Color("#FF2A85")  // 100%: Плотный неоновый розовый (максимум, без белого!)
        ];
